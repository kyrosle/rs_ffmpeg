...
pub unsafe fn opt_set(
  ...
  unsafe { ffi::av_opt_set(obj, name.as_ptr(), val.as_ptr(), search_flags) }
    .upgrade()?;
  Ok(())
}
...
pub unsafe fn opt_set_image_size(
  ...
  unsafe { ffi::av_opt_set_image_size(obj, name.as_ptr(), w, h, search_flags) }
    .upgrade()?;
  Ok(())
}
...
pub unsafe fn opt_set_pixel_fmt(
  ...
  unsafe { ffi::av_opt_set_pixel_fmt(obj, name.as_ptr(), fmt, search_flags) }
    .upgrade()?;
  Ok(())
}
...
pub unsafe fn opt_set_sample_fmt(
  ...
  unsafe { ffi::av_opt_set_sample_fmt(obj, name.as_ptr(), fmt, search_flags) }
    .upgrade()?;
  Ok(())
}
...
pub unsafe fn opt_set_video_rate(
  ...
  unsafe { ffi::av_opt_set_video_rate(obj, name.as_ptr(), val, search_flags) }
    .upgrade()?;
  Ok(())
}
